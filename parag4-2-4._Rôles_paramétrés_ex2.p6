...
#`[
* Created By : sdo
* File Name : parag4-2-4._Rôles_paramétrés_ex2.p6
* Creation Date : Sat Sep 29 21:43:30 2018
* Last Modified : Sun Sep 30 00:15:10 2018
...
* Purpose :
		Change Type to MyType from previous exemple
]
# ------------------------------------------------------

role ArbreBinaire[::MyType] {
    has ArbreBinaire[MyType] $.gauche;
    has ArbreBinaire[MyType] $.droite;
    has MyType $.noeud;
