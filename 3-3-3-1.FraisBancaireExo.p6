...
#`[
* Created By : sdo
* File Name : 3-3-3-1.FraisBancaireExo.p6
* Creation Date : Tue Sep 11 23:21:17 2018
* Last Modified : Wed Sep 12 19:14:08 2018
...
* Purpose :
	À titre d'exercice, vous pouvez ajouter une nouvelle fonctionnalité : le prélèvement d'une commission de 10 € pour toute tentative de retrait 
	dépassant la provision du compte. Vous pouvez également essayer de créer un compte de type épargne permettant de calculer un intérêt versé par 
	la banque à son client (calculé simplement comme un pourcentage du montant figurant au crédit du compte).
]
# ------------------------------------------------------
