...
#`[
* Created By : sdo
* File Name : parag4-1-6-1.exo2.Attributs_de_classe.p6
* Creation Date : Fri Sep 21 16:08:33 2018
* Last Modified : Sat Sep 22 13:39:30 2018
...
class Employé {
    ...
    method get-matricule { $matricule; }
...
say "Matricule de l'employé : " ~ $salarié.get-matricule;
...
say "Matricule de l'employé : " ~ $salarié2.get-matricule;
