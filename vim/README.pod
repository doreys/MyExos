...
In the directory <base_dir>/.vim two directories need to be created.

The mkdir command is needed to be created.
...
This tuto was based on the tuto written here: https://www.thegeekstuff.com/2008/12/vi-and-vim-autocommand-3-steps-to-add-custom-header-to-your-file/
